Step 1: download the project and navigate to project folder 

Step 2: create a collection named collections ( mongodb shuold be installed )
Step 3: open the command prompt from the folder path and run npm i command ( angular cli should be installed )

Step 4: after that run npm install pm2 -g for golbal installation
Step 5: 
